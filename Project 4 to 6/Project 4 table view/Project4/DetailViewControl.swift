...
class DetailViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        webView.load(URLRequest(url: url))                  //webview can not directly load and URL, it need go to through URLResqurest
        ...
        progressView = UIProgressView(progressViewStyle: .bar)  //.bar will not pre-draw a full gray of progress, why .default will have a pre-draw 100% gray one
