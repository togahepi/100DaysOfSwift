...
//  Project6b
//
//  Created by user197801 on 5/17/21.
//
...
//        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-[label1(labelHeight@999)]-[label2(label1)]-[label3(label1)]-[label4(label1)]-[label5(label1)]-(>=10)-|", options: [], metrics: metrics, views: viewDictionary))   //@999 is lower priority than default 1000 for constraints or heigh....
...
//            label.widthAnchor.constraint(equalTo: view.safeAreaLayoutGuide.widthAnchor).isActive = true
            ...
            if let previous = previous {
                //we have previous so we creat topAnchor
                label.topAnchor.constraint(equalTo: previous.bottomAnchor, constant: 10).isActive = true
            } else {
                //this is for the first label to avoid the notch
